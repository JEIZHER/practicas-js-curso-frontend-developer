...
const producDetailImg=document.querySelector('#image');
const producDetailPrice=document.querySelector('#precio');
const producDetailName=document.querySelector('#nombre');
const producDetailDescription=document.querySelector('#descripcion');
...
function clickEnProducto(image , precio , nombre , descripcion){
    productDetailContainer.classList.remove('inactive');
    shopingCartContainer.classList.add('inactive');
    desktopMenu.classList.add('inactive');
    mobileMenu.classList.add('inactive');

    producDetailImg.setAttribute('src', image);
    producDetailPrice.innerText = '$' + precio;
    producDetailName.innerText = nombre;
    producDetailDescription.innerText = descripcion;
...
productList.push({
    ...
    descripcion: 'excelente bicicleta bla bla bla'
});
productList.push({
    name: 'Bicycle helmet',
    price: 1600,
    image: 'https://m.media-amazon.com/images/I/61eExL-rIAL._AC_SL1001_.jpg',
    descripcion: 'Maxima proteccion bla bla y bla bla'
});
productList.push({
    name: 'Bicycle helmet',
    price: 1500,
    image: 'https://assets.specialized.com/i/specialized/60822-140_HLMT_CHAMONIX-HLMT-MIPS-CE-MRN-M-L_HERO?bg=rgb(241,241,241)&w=1600&h=900&fmt=auto',
    descripcion: 'otro casco bonito bla bla'
});
productList.push({
    name: 'Seat',
    price: 300,
    image: 'https://m.media-amazon.com/images/I/61e+sZ9rgNL._AC_SL1500_.jpg',
    descripcion:'el mejor asiento de bici bla bla bla'
});
productList.push({
    name: 'Tennis Montain Bike',
    price: 2200,
    image: 'https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/8ea578f6c07847fca2d0ac85011d7f1f_9366/Tenis_para_Mountain_Bike_Five_Ten_Freerider_Negro_FW2835_01_standard.jpg',
    descripcion:'El mejor tennis para montar bici bla bla bla'
});
productList.push({
    name: 'Sunglasses',
    price: 800,
    image: 'https://cdn.siroko.com/s/files/1/1220/6874/products/gafas-siroko-tech-k3s-london-lateral/1200x/crop_center.jpg?v=1635209602',
    descripcion:'proteccion para la vista los mejores lentes de sol bla bla bla'
});
productList.push({
    name: 'Sunglasses',
    price: 600,
    image: 'https://cdn.siroko.com/s/files/1/1220/6874/products/siroko-tech-k3s-clearfog-lente-antiniebla-frontal/1200x/crop_center.jpg?v=1635209603',
    descripcion:'otros maravillosos lentes de so bla bla bla'
});
...
for (let produc of array) {
    ...
    productImage.addEventListener('click',function(){clickEnProducto(produc.image,produc.price,produc.name,produc.descripcion)} );
